...
from visualization import plot_monthly_heatmap, plot_yearly_diff_comparison
...
def run():
    ...
    df_etf = yf.Ticker("EXS1.DE").history(start=training_period, end=config.end_date)
